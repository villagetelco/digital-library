...
VER="Digital-Library-01-MS14-"$DIRVER

echo "************************************"
echo ""
echo "Build script for Digital library MS14 device"
...
DATE=`date +%Y-%m-%d-%H:%M`
DIR=$DATE"-MS14-Digital-Library-"$DIRVER
...
echo " "
echo " Build script MS14 Digital Library complete"
echo " "
echo '----------------------------'
